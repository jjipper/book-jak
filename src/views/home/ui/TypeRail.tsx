...
import {
  ...
  rarityBadgeVariant,
  RARITY_BADGE_LABELS,
} from "@/entities/reading-type/model/readingTypes";
  ...
  return (
    <section className="bj-section">
      <SectionHead
        ...
        icon={
          <img
            src="/assets/icons/club-sparkle.png"
            alt=""
      ...
      <div className="bj-rail">
        {TYPE_CODES.map((code) => {
          ...
          return (
            <Link key={code} href={`/result/${code}`} className="bj-type-card">
              <div className="bj-type-card__illust">
                ...
                <span className="bj-type-card__rarity">
                  <RarityBadge
                    variant={variant}
                    label={RARITY_BADGE_LABELS[badge]}
                    size="xs"
                  />
                </span>
              </div>
              <p className="bj-type-card__name">{t.name}</p>
            </Link>
          );
        })}
      </div>
