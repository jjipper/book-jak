      ...
      <div className="bj-rail bj-rail--lg-grid-2">
        {clubs.map((club) => (
          <Link
            ...
            className="bj-club-card"
          >
            <div className="bj-club-card__thumb">
              <IllustPlaceholder
                code={club.illust ?? `club-${club.id}`}
                alt={club.name}
                aspectRatio="1 / 1"
                fallback="slot"
                fit="contain"
            ...
            <div className="bj-club-card__body">
              <p className="bj-club-card__name">{club.name}</p>
              <div className="bj-club-card__chips">
                <span className="bj-club-card__chip bj-club-card__chip--format">
                  {club.format}
                </span>
                ...
                {club.region && (
                  <span className="bj-club-card__chip">{club.region}</span>
                )}
              </div>
              <p className="bj-club-card__desc bj-clamp-1">
                {club.description}
              </p>
              <p className="bj-club-card__tags">
