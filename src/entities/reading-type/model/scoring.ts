import { QUESTIONS, type AxisValue } from '@/entities/reading-type/model/questions'
import { READING_TYPES, type TypeCode, type StatKey } from '@/entities/reading-type/model/readingTypes'
