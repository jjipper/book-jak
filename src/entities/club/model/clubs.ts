...
export const SEED_CLUBS: BookClub[] = [
  ...
  { id: 'c02', name: '울고 싶은 사람들', description: '슬픈 에세이 읽고 같이 울고 위로받는 모임', tags: ['에세이'], capacity: 6, memberCount: 6, format: '오프라인', region: '서울 마포', organizerId: 'p02' },
  ...
  { id: 'c05', name: '스릴러 정주행단', description: '한 달에 스릴러 3권, 스포일러 금지 토론', tags: ['스릴러', '토론'], capacity: 8, memberCount: 3, format: '오프라인', region: '부산 서면', organizerId: 'p05' },
  { id: 'c06', name: '질문만 있는 독서모임', description: '결론 안 냄. 질문만 계속 던지다가 헤어짐', tags: ['토론', '고전'], capacity: 6, memberCount: 2, format: '오프라인', region: '서울 성수', organizerId: 'p07' },
]
