...
import { lookupExternalBook, type ExternalBook } from '@/lib/externalBooks'
import { getBookRating, saveBookRating, removeBookRating, type BookRatingRecord } from '@/lib/bookRatings'
